...
test('self-hosted scans fail closed unless they reserve shared host capacity', async () => {
  ...
  assert.match(
    workflow,
    /uses: kontourai\/\.github\/actions\/physical-host-capacity@98e0f605188a090f02d84a47baa5702221f6dfa6/,
  );
  for (const input of [
    ...
    'owner-lifetime-seconds: ${{ inputs.capacity-owner-lifetime-seconds }}',
  ]) {
